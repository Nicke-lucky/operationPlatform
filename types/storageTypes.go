...
type BDmChongq struct {
	...
	FNbChongqlxgzsc int       `gorm:"column:_NB_CHONGQLXGZSC"` //`F_NB_CHONGQLXGZSC` bigint(20) DEFAULT NULL COMMENT '重启前连续工作时长 单位：秒',
...
type BDmWanggjcxx struct {
	...
	FVcIpdz       string    `gorm:"column:F_VC_IPDZ"`       //	`F_VC_IPDZ` varchar(32) DEFAULT NULL COMMENT 'IP地址',
	FNbCPUsyl     int       `gorm:"column:F_NB_CPUSYL"`     //	`F_NB_CPUSYL` decimal(32, 10) DEFAULT NULL COMMENT 'CPU使用率 百分比',
	FNbNeicsyl    int       `gorm:"column:F_NB_NEICSYL"`    //	`F_NB_NEICSYL` decimal(32, 10) DEFAULT NULL COMMENT '内存使用率 百分比',
	FNbYsyncdx    int       `gorm:"column:F_NB_YISYNCDX"`   //	`F_NB_YISYNCDX` decimal(32, 10) DEFAULT NULL COMMENT '已使用内存大小 单位：MB',
	FNbZongncdx   int       `gorm:"column:F_NB_ZONGNCDX"`   //	`F_NB_ZONGNCDX` decimal(32, 10) DEFAULT NULL COMMENT '总内存大小 单位：MB',
	FNbYingpsyl   int       `gorm:"column:F_NB_YINGPSYL"`   //	`F_NB_YINGPSYL` decimal(32, 10) DEFAULT NULL COMMENT '硬盘使用率 百分比',
	FNbYisyypdx   int       `gorm:"column:F_NB_YISYYPDX"`   //	`F_NB_YISYYPDX` decimal(32, 10) DEFAULT NULL COMMENT '已使用硬盘大小 单位：GB',
	FNbZongypdx   int       `gorm:"column:F_NB_ZONGYPDX"`   //	`F_NB_ZONGYPDX` decimal(32, 10) DEFAULT NULL COMMENT '总硬盘大小 单位：GB',
